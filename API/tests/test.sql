...
INSERT INTO `teams` VALUES(1, 'FuRy', 'Andrew is a god');
INSERT INTO `teams` VALUES(2, 'Artemis', 'Not your average expieriance');
INSERT INTO `teams` VALUES(3, 'Faze', 'Olof is a criminal');
INSERT INTO `teams` VALUES(4, 'Outer Heavan', '... wtf');
INSERT INTO `users` (`id`, `username`, `password`, `team_id`, `request_key`, `description`, `role`) VALUES(1, 'Caleb', '$2b$12$3uvat8KCq5K0okD.lBIPROOYDOqT7J12p.hNFZs/E2lXNCfR/u/8m', 1, '$2b$12$3uvat8KCq5K0okD.lBIPROOYDOqT7J12p.hNFZs/E2lXNCfR/u/8m', 'Just your average player', 1);
INSERT INTO `users` (`id`, `username`, `password`, `team_id`, `description`, `role`) VALUES(2, 'Bobby', '$2b$12$3uvat8KCq5K0okD.lBIPROOYDOqT7J12p.hNFZs/E2lXNCfR/u/8m', 3, 'pass me another cold one', 1);
