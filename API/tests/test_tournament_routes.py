...
class Requests(unittest.TestCase):
    ...
    def test_post_tournament(self):
        r = requests.post(url + 'tournaments', data={"name": "Test", "type": 1, "size": 4, "start_date": "2018-12-30 20:00:00", "entry_fee": 1000, "description": "Test"})
    ...
    def test_edit_tournament(self):
        ...
        r = requests.put(url + 'tournaments/1', data={"name": "Test", "type": 2, "size": 2, "start_date": "2018-01-02 08:00:00", "end_date": "2018-01-23", "entry_fee": 10000, "description": "Test"})
